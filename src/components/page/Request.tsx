      ...
      <div className="rounded-md border bg-white px-8 py-6 shadow-xl">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="mb-4 flex flex-col">
            ...
            <input type="text" id="location" className="appearance-none rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-75" onChange={handleInputChange} />
          </div>
