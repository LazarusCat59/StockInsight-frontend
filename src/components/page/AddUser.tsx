      ...
      <div className='w-screen'>
        ...
        <div className="mx-60 mt-3">
          <select
            id="role"
            name="role"
            className=" block w-64 h-12 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            value={selectedRole}
        ...
        <div className="mx-60 mt-5 space-x-3">
          ...
          <button
            ...
            onClick={() => removeUser(selectedRole)}
          >
            Remove User
          </button>
        </div>
